#
cd native
../clang/configure --enable-optimized --disable-assertions --disable-jit --disable-threads --disable-pthreads --enable-targets=sparc
make -j 4
cd ..
cd js
emconfigure ../clang/configure --enable-optimized --disable-assertions --disable-jit --disable-threads --disable-pthreads --enable-targets=sparc
make
...
EMCC_DEBUG=1 emcc -O2 clang.bc -o clang.js -s ASM_JS=2 -s OUTLINING_LIMIT=110000
